...
-include vendor/walton/primo_gm/BoardConfigVendor.mk

DEVICE_FOLDER := device/walton/primo_gm
...
TARGET_BOOTLOADER_BOARD_NAME := primo_gm

# Kernel 
BOARD_KERNEL_CMDLINE :=
TARGET_PREBUILT_KERNEL := device/walton/primo_gm/rootdir/root/kernel
BOARD_CUSTOM_BOOTIMG_MK := device/walton/primo_gm/bootimg.mk
...
TARGET_RECOVERY_FSTAB := $(DEVICE_FOLDER)/rootdir/recovery/recovery.fstab
BOARD_HAS_MTK := true
...
TARGET_COMMON_NAME := primo_gm
BOARD_USE_MTK_LAYOUT := true
BOARD_USE_NTFS_3G := false
TARGET_SCREEN_WIDTH := 720
TARGET_SCREEN_HEIGHT := 1280
TARGET_USE_CUSTOM_LUN_FILE_PATH := /sys/class/android_usb/android0/f_mass_storage/lun/file
TARGET_DEVICE := primo_gm
